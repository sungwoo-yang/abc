...
private:
    ...
    OpenGL::CompiledShader fishShader{};
    ...
    static constexpr std::size_t MAX_NUMBER_FISH = 16384;
...
private:
    ...
    void increase_number_of_fishes(std::size_t current_size);
    void decrease_number_of_fishes(std::size_t current_size);
    void regenerate_all_fishes();
    void generateRandomFish(FishData& fishData, const Math::vec2& screenSize) const;
    void updateFishes();
};